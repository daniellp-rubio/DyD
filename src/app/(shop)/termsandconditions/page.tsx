    ...
    <>
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="TÉRMINOS Y CONDICIONES" />
          <p>
            GADGETSD&D gestiona este sitio web. En todo el sitio, los términos «nosotros», «nos» y «nuestro» se refieren en lo sucesivo a GADGETSD&D. GADGETSD&D ofrece esta página web, incluida toda la información, las herramientas y los servicios que se ponen en este sitio a disposición suya, el usuario, siempre y cuando acepte la totalidad de los términos, condiciones, políticas y avisos contemplados aquí.
          </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="TÉRMINOS DE LA TIENDA ONLINE" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="CONDICIONES GENERALES" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="EXACTITUD, TOTALIDAD Y CRONOLOGÍA DE LA INFORMACIÓN" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="MODIFICACIONES AL SERVICIO Y PRECIOS" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="PRODUCTOS O SERVICIOS" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="HERRAMIENTAS OPCIONALES" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="ENLACES DE TERCEROS" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="COMENTARIOS DE LOS USUARIOS, OPINIONES Y OTRAS COMUNICACIONES" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="DEVOLUCIONES" />
          <p>
            Si desea hacer la devolucion del producto por casos de insatisfaccion, producto equivocado, tiempo inesperado y cualquier indole en la paqueteria y/o producto el cliente respondera por el costo de envio en la devolucion.  No se hacen devoluciones de dinero en ninguno de estos casos y se le enviara un producto nuevo bajo la  responsabilidad de GADGETSD&D.
          </p>
      </div>

      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="INDEMNIZACIÓN" />
          <p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="RESCISIÓN" />
          <p>
            as obligaciones y responsabilidades de las partes incurridas antes de la fecha de rescisión seguirán vigentes después de la rescisión de este contrato a todos los efectos.
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <Title title="CAMBIOS EN LOS TÉRMINOS DEL SERVICIO" />
          <p>
